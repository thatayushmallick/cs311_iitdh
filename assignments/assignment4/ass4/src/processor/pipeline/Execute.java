...
public class Execute {
	...
	public void performEX()
	{
		...
		int B=0;
		int rem= 0;
		OF_EX_Latch.setcond(false);

		if(rd==100){
			System.out.println("this is nop in EX");
			EX_MA_Latch.setRd(100);
			return;
		}
		switch (operation) {
			case add:
			...
			case beq:
				...
				break;
				case end:
					int end_pc=OF_EX_Latch.getend_pc();
					EX_MA_Latch.setend_pc(end_pc);
					break;
